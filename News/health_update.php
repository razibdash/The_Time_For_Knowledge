    ...
    <div class="sidebar">
        ...
        <h3 class="dash"><a href="Admin.php">Dashboard</a></h3>
            <div class="row">
                ...
                <div class="new-book">
                <form action="php_core\health_up.php?newsHealth=true" method="post" enctype="multipart/form-data" >
                    <div class="student">
                        <h2 class='add-title '>Add health News<i class="bi bi-plus-circle-dotted"></i></h2>
                    </div>
                        <div class="mb-3 mt-3">
        ...
        ?>
         ...
         <tr>
            <td class='serial'><?php echo $count?></td>
             ...
             <td><?php echo $date?></td>
             <td><a href="php_core/health_delete.php?id=<?php echo $id ?>">Delete</a></td>
         <?php 
